...
import { listPayments, paymentMethods } from '@/server/services/payments'
...
export default async function DepositPage() {
  ...
  return (
    <Suspense>
      <DepositView config={cfg} payments={payments} bonusPercent={auth.user.depositBonusPercent} methods={paymentMethods()} />
    </Suspense>
  )
}
